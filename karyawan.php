...
<h3>Data Karyawan The Witari</h3>
<h6></h6>
...
?>
     <tr>
     <td><?php echo oci_result($stid, 'ID_KARYAWAN');?></td>
     <td><?php echo oci_result($stid, 'NAMA_KARYAWAN') ;?></td>
     <td><?php echo oci_result($stid, 'ALAMAT_KARYAWAN');?></td>
     <td><?php echo oci_result($stid, 'PEKERJAAN_KARYAWAN');?></td>
     <td><?php echo oci_result($stid, 'TELP_KARYAWAN');?></td>
     <td>
     <a href="update_form.php?ID_KARYAWAN=<?php echo oci_result($stid, 'ID_KARYAWAN'); ?>">EDIT</a>
     </td>
     </tr>
<?php
 }
