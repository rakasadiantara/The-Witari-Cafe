  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="bos.php">Home</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-lg-flex">
            <a href="#pesan" class="btn-get-started scrollto">Pembelian</a>
...
try {
    ...
    $dbh = oci_new_connect('c##ecommerce','ecommerce','localhost/orcl');
    ...
    {
        echo "<tr>";
        echo "<td>".oci_result($stid, 'ID_TRANSAKSI')."</td>";
        echo "<td>".oci_result($stid, 'ESPRESSO')."</td>";
        echo "<td>".oci_result($stid, 'MOCHA')."</td>";
        echo "<td>".oci_result($stid, 'CAPPUCINO')."</td>";
        echo "<td>".oci_result($stid, 'LATTE')."</td>";   
        echo "<td>".oci_result($stid, 'COOKIES')."</td>";
        echo "<td>".oci_result($stid, 'CUPCAKE')."</td>";
        echo "<td>".oci_result($stid, 'CHEESECAKE')."</td>";
        echo "<td>".oci_result($stid, 'ROLLCAKE')."</td>";
        echo "<td>".oci_result($stid, 'STATUS')."</td>";
        echo "<td>".oci_result($stid, 'TOTAL')."</td>";
        echo "<td>".oci_result($stid, 'WAKTU_TRANSAKSI')."</td>";
        echo "</tr>";
    }
    $dbh = null;
}
